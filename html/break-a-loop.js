...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = '/mnt/Dev/Rust/Games/break-a-loop/target/wasm32-unknown-emscripten/debug/deps/break_a_loop.data';
      var REMOTE_PACKAGE_BASE = 'break_a_loop.data';
  ...
  Module['FS_createPath']("/", "Assets", true, true);
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_/mnt/Dev/Rust/Games/break-a-loop/target/wasm32-unknown-emscripten/debug/deps/break_a_loop.data');

      };
      Module['addRunDependency']('datafile_/mnt/Dev/Rust/Games/break-a-loop/target/wasm32-unknown-emscripten/debug/deps/break_a_loop.data');
   ...
   loadPackage({"files": [{"filename": "/Assets/dummy.txt", "start": 0, "end": 0}], "remote_package_size": 0, "package_uuid": "6a391b2a-e133-4c0e-984a-61fbc3d08cd1"});
...
var wasmBinaryFile;
  wasmBinaryFile = 'break_a_loop.wasm';
